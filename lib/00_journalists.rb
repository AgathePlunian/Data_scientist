...
#Combien y a-t-il de journalistes dans ce array ?
 ...
 puts " Journalistes se trouvent dans cette array "

#Combien d'handle contiennent un numéro ?
test = journalists.each.grep(/[[:digit:]]/)
print test.size 
puts " handles contiennent des numéros"

#Combien d'handle contiennent les 4 lettres du prénom "Aude" à la suite (sans prendre en compte les majuscules) ?
aude = journalists.each.grep(/aude/)
print aude.size
puts " il y a tel nombre de aude dans les handles"

#Combien commencent par une majuscule (première lettre juste après le @) ?
arobaz_maj = journalists.each.grep(/@[[:upper:]]/)
 print arobaz_maj.size
 puts " Handle contiennent une majuscule après le @"

#Combien contiennent une majuscule ?
maj = journalists.each.grep(/[[:upper:]]/)
 print maj.size
 puts " Handle contiennent une majuscule"

#Combien y a-t-il de underscore _ dans tous les pseudos confondus ?
under_score = journalists.each.grep(/_/)
print under_score.size
puts " il y a tel nombre _ dans les handles"


#Trie la liste de handle par ordre alphabétique.
alphabetique = journalists.sort
print alphabetique

puts " "

#Quels sont les 50 handles les plus courts de ce array ?
result = journalists.sort_by!{|word|word.length}
puts result [0..50]

#Quelle est la position dans l'array de la personne @epenser ?
print journalists.index ("@epenser")
puts " Est le numero de l'index dans lequel se trouve @epenser"
